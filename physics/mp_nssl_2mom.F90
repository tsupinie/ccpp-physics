...
!! | qh              | hail_mixing_ratio_updated_by_physics                                  | hail mixing ratio wrt dry+vapor (no condensates)                      | kg kg-1    |    2 | real      | kind_phys | inout  | F        |
...
!! | nc              | cloud_droplet_number_concentration_updated_by_physics                 | cloud droplet number concentration                                    | kg-1       |    2 | real      | kind_phys | inout  | F        |
!! | ns              | snow_number_concentration_updated_by_physics                          | snow number concentration                                             | kg-1       |    2 | real      | kind_phys | inout  | F        |
!! | ng              | graupel_number_concentration_updated_by_physics                       | graupel number concentration                                          | kg-1       |    2 | real      | kind_phys | inout  | F        |
!! | nh              | hail_number_concentration_updated_by_physics                          | hail number concentration                                             | kg-1       |    2 | real      | kind_phys | inout  | F        |
!! | nqvolg          | graupel_particle_volume_updated_by_physics                            | volume of graupel particle updated by physics                         | m3 kg-1    |    2 | real      | kind_phys | inout  | F        |
!! | nqvolh          | hail_particle_volume_updated_by_physics                               | volume of hail particle updated by physics                            | m3 kg-1    |    2 | real      | kind_phys | inout  | F        |
...
!! | sr              | ratio_of_snowfall_to_rainfall                                         | ratio of snowfall to large-scale rainfall                             | frac       |    1 | real      | kind_phys | inout  | F        |
